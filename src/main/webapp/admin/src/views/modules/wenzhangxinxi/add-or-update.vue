    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.wenzhangfengmian" label="文章封面" prop="wenzhangfengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.wenzhangfengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="文章简介" prop="wenzhangjianjie">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.wenzhangjianjie" label="文章简介" prop="wenzhangjianjie">
                    <span>{{ruleForm.wenzhangjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.wenzhangneirong = this.ruleForm.wenzhangneirong.replace(reg,'../../../ssm34f5g/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
